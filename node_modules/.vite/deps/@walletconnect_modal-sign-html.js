    ...
    (function(factory) {
      ...
      __rest = function(s, e) {
        ...
        if (s != null && typeof Object.getOwnPropertySymbols === "function")
          for (var i3 = 0, p5 = Object.getOwnPropertySymbols(s); i3 < p5.length; i3++) {
            if (e.indexOf(p5[i3]) < 0 && Object.prototype.propertyIsEnumerable.call(s, p5[i3]))
              t[p5[i3]] = s[p5[i3]];
          }
        return t;
      };
      ...
      __generator = function(thisArg, body) {
        ...
        function step(op) {
          ...
          while (_3)
            try {
              if (f2 = 1, y5 && (t = op[0] & 2 ? y5["return"] : op[0] ? y5["throw"] || ((t = y5["return"]) && t.call(y5), 0) : y5.next) && !(t = t.call(y5, op[1])).done)
                return t;
              if (y5 = 0, t)
                op = [op[0] & 2, t.value];
              switch (op[0]) {
      ...
      __values = function(o2) {
        var s = typeof Symbol === "function" && Symbol.iterator, m3 = s && o2[s], i3 = 0;
        if (m3)
          return m3.call(o2);
      ...
      __spreadArrays = function() {
        ...
        for (var r2 = Array(s), k2 = 0, i3 = 0; i3 < il; i3++)
          for (var a3 = arguments[i3], j3 = 0, jl = a3.length; j3 < jl; j3++, k2++)
            r2[k2] = a3[j3];
        return r2;
      };
      __await = function(v) {
          ...
          if (g5[n3])
            i3[n3] = function(v) {
              return new Promise(function(a3, b3) {
                q4.push([n3, v, a3, b3]) > 1 || resume(n3, v);
              });
            };
        }
      ...
      __asyncDelegator = function(o2) {
        ...
        function verb(n3, f2) {
          i3[n3] = o2[n3] ? function(v) {
            return (p5 = !p5) ? { value: __await(o2[n3](v)), done: n3 === "return" } : f2 ? f2(v) : v;
          } : f2;
        }
      };
...
var require_ed25519 = __commonJS({
  "node_modules/@stablelib/ed25519/lib/ed25519.js"(exports) {
    ...
    function sel25519(p5, q4, b3) {
      const c2 = ~(b3 - 1);
      for (let i3 = 0; i3 < 16; i3++) {
        const t = c2 & (p5[i3] ^ q4[i3]);
        p5[i3] ^= t;
        q4[i3] ^= t;
      }
    }
    ...
    function edadd(p5, q4) {
      const a3 = gf(), b3 = gf(), c2 = gf(), d3 = gf(), e = gf(), f2 = gf(), g5 = gf(), h4 = gf(), t = gf();
      sub(a3, p5[1], p5[0]);
      sub(t, q4[1], q4[0]);
      mul(a3, a3, t);
      add(b3, p5[0], p5[1]);
    ...
    function cswap(p5, q4, b3) {
      for (let i3 = 0; i3 < 4; i3++) {
        sel25519(p5[i3], q4[i3], b3);
      }
    }
    function pack(r2, p5) {
    ...
    function modL(r2, x4) {
      ...
      for (i3 = 63; i3 >= 32; --i3) {
        carry = 0;
        for (j3 = i3 - 32, k2 = i3 - 12; j3 < k2; ++j3) {
          x4[j3] += carry - 16 * x4[i3] * L3[j3 - (i3 - 32)];
  ...
  "node_modules/@stablelib/chacha/lib/chacha.js"(exports) {
    ...
    function streamXOR(key, nonce, src2, dst, nonceInplaceCounterLength) {
      ...
      for (var i3 = 0; i3 < src2.length; i3 += 64) {
        core(block, nc, key);
        for (var j3 = i3; j3 < i3 + 64 && j3 < src2.length; j3++) {
          dst[j3] = src2[j3] ^ block[j3 - i3];
        }
...
var require_sha256 = __commonJS({
  "node_modules/@stablelib/sha256/lib/sha256.js"(exports) {
    ...
    function hashBlocks(w4, v, p5, pos, len) {
      while (len >= 64) {
        var a3 = v[0];
        var b3 = v[1];
        var c2 = v[2];
        ...
        for (var i3 = 0; i3 < 16; i3++) {
          var j3 = pos + i3 * 4;
          w4[i3] = binary_1.readUint32BE(p5, j3);
        }
        ...
        for (var i3 = 0; i3 < 64; i3++) {
          var t1 = (((e >>> 6 | e << 32 - 6) ^ (e >>> 11 | e << 32 - 11) ^ (e >>> 25 | e << 32 - 25)) + (e & f2 ^ ~e & g5) | 0) + (h4 + (K2[i3] + w4[i3] | 0) | 0) | 0;
...
var alphabetBytesToChars = alphabet.reduce((p5, c2, i3) => {
  p5[i3] = c2;
  return p5;
}, []);
var alphabetCharsToBytes = alphabet.reduce((p5, c2, i3) => {
  p5[c2.codePointAt(0)] = i3;
  return p5;
}, []);
function encode2(data) {
  return data.reduce((p5, c2) => {
    p5 += alphabetBytesToChars[c2];
    return p5;
  }, "");
}
...
function kn(e, n3) {
  const t = fe.sharedKey(fromString2(e, p3), fromString2(n3, p3)), r2 = new import_hkdf.HKDF(import_sha256.SHA256, t).expand(X);
...
function Kn(e) {
  const n3 = Pe(typeof e.type < "u" ? e.type : Q);
  if ($(n3) === _ && typeof e.senderPublicKey > "u")
    throw new Error("Missing sender public key for type 1 envelope");
  const t = typeof e.senderPublicKey < "u" ? fromString2(e.senderPublicKey, p3) : void 0, r2 = typeof e.iv < "u" ? fromString2(e.iv, p3) : (0, import_random2.randomBytes)(Z), o2 = new import_chacha20poly1305.ChaCha20Poly1305(fromString2(e.symKey, p3)).seal(r2, fromString2(e.message, x));
  return Te({ type: n3, sealed: o2, iv: r2, senderPublicKey: t });
}
function Ln(e) {
  const n3 = new import_chacha20poly1305.ChaCha20Poly1305(fromString2(e.symKey, p3)), { sealed: t, iv: r2 } = ee(e.encoded), o2 = n3.open(r2, t);
  if (o2 === null)
...
function ee(e) {
  const n3 = fromString2(e, L), t = n3.slice($n, Ie), r2 = Ie;
  if ($(t) === _) {
    const l2 = r2 + X, d3 = l2 + Z, c2 = n3.slice(r2, l2), u3 = n3.slice(l2, d3), a3 = n3.slice(d3);
    return { type: t, sealed: a3, iv: u3, senderPublicKey: c2 };
  }
  const o2 = r2 + Z, s = n3.slice(r2, o2), i3 = n3.slice(o2);
  return { type: t, sealed: i3, iv: s };
}
function xn(e, n3) {
  const t = ee(e);
  return Re({ type: $(t.type), senderPublicKey: typeof t.senderPublicKey < "u" ? toString2(t.senderPublicKey, p3) : void 0, receiverPublicKey: n3 == null ? void 0 : n3.receiverPublicKey });
}
function Re(e) {
  const n3 = (e == null ? void 0 : e.type) || Q;
  if (n3 === _) {
...
var Ue = (e, n3, t) => n3 in e ? Hn(e, n3, { enumerable: true, configurable: true, writable: true, value: t }) : e[n3] = t;
var _e = (e, n3) => {
  for (var t in n3 || (n3 = {}))
    qn.call(n3, t) && Ue(e, t, n3[t]);
  if (Ae)
    for (var t of Ae(n3))
      Bn.call(n3, t) && Ue(e, t, n3[t]);
  return e;
};
var Ce = "ReactNative";
...
function De(e, n3) {
  let t = k.parse(e);
  return t = _e(_e({}, t), n3), e = k.stringify(t), e;
}
function zn() {
...
function Ve() {
  var e;
  const n3 = R();
  return n3 === m.browser ? [n3, ((e = (0, import_window_getters.getLocation)()) == null ? void 0 : e.host) || "unknown"].join(":") : n3;
}
function Me(e, n3, t) {
  const r2 = ke(), o2 = Ve();
  return [[e, n3].join("-"), [je, t].join("-"), r2, o2].join("/");
}
function Jn({ protocol: e, version: n3, relayUrl: t, sdkVersion: r2, auth: o2, projectId: s, useOnCloseEvent: i3 }) {
  const l2 = t.split("?"), d3 = Me(e, n3, r2), c2 = { auth: o2, ua: d3, projectId: s, useOnCloseEvent: i3 || void 0 }, u3 = De(l2[1] || "", c2);
  return l2[0] + "?" + u3;
}
function O(e, n3) {
...
function st(e = import_time2.FIVE_MINUTES, n3) {
...
async function pt({ id: e, topic: n3, wcDeepLink: t }) {
  try {
    if (!t)
      return;
    ...
    const s = `${o2}/wc?requestId=${e}&sessionTopic=${n3}`, i3 = R();
    i3 === m.browser ? s.startsWith("https://") ? window.open(s, "_blank", "noreferrer noopener") : window.open(s, "_self", "noreferrer noopener") : i3 === m.reactNative && typeof (global == null ? void 0 : global.Linking) < "u" && await global.Linking.openURL(s);
  } catch (r2) {
    console.error(r2);
  }
}
...
var qe = (e, n3, t) => n3 in e ? ht(e, n3, { enumerable: true, configurable: true, writable: true, value: t }) : e[n3] = t;
var Et = (e, n3) => {
  for (var t in n3 || (n3 = {}))
    vt.call(n3, t) && qe(e, t, n3[t]);
  if (He)
    for (var t of He(n3))
      gt.call(n3, t) && qe(e, t, n3[t]);
  return e;
};
function Be(e, n3 = "-") {
  const t = {}, r2 = "relay" + n3;
...
function bt(e) {
  const n3 = e.indexOf(":"), t = e.indexOf("?") !== -1 ? e.indexOf("?") : void 0, r2 = e.substring(0, n3), o2 = e.substring(n3 + 1, t).split("@"), s = typeof t < "u" ? e.substring(t) : "", i3 = k.parse(s);
...
function N(e, n3) {
  const { message: t, code: r2 } = Ct[e];
  return { message: n3 ? `${t} ${n3}` : t, code: r2 };
}
function U(e, n3) {
  const { message: t, code: r2 } = _t[e];
  return { message: n3 ? `${t} ${n3}` : t, code: r2 };
}
function j(e, n3) {
...
function h2(e, n3) {
  return n3 && w(e) ? true : typeof e == "string" && !!e.trim().length;
}
function G(e, n3) {
  return n3 && w(e) ? true : typeof e == "number" && !isNaN(e);
}
function $t(e, n3) {
  const { requiredNamespaces: t } = n3, r2 = Object.keys(e.namespaces), o2 = Object.keys(t);
  let s = true;
  return O(o2, r2) ? (r2.forEach((i3) => {
    const { accounts: l2, methods: d3, events: c2 } = e.namespaces[i3], u3 = A(l2), a3 = t[i3];
    (!O(M(i3, a3), u3) || !O(a3.methods, d3) || !O(a3.events, c2)) && (s = false);
  }), s) : false;
}
function D(e) {
...
function Vt(e, n3) {
  let t = null;
  return h2(e == null ? void 0 : e.publicKey, false) || (t = N("MISSING_OR_INVALID", `${n3} controller public key should be a string`)), t;
}
function ie(e) {
  let n3 = true;
  return j(e) ? e.length && (n3 = e.every((t) => h2(t, false))) : n3 = false, n3;
}
function nn(e, n3, t) {
  let r2 = null;
  return j(n3) && n3.length ? n3.forEach((o2) => {
    r2 || D(o2) || (r2 = U("UNSUPPORTED_CHAINS", `${t}, chain ${o2} should be a string and conform to "namespace:chainId" format`));
  }) : D(e) || (r2 = U("UNSUPPORTED_CHAINS", `${t}, chains must be defined as "namespace:chainId" e.g. "eip155:1": {...} in the namespace key OR as an array of CAIP-2 chainIds e.g. eip155: { chains: ["eip155:1", "eip155:5"] }`)), r2;
}
function tn(e, n3, t) {
  let r2 = null;
  return Object.entries(e).forEach(([o2, s]) => {
    if (r2)
      return;
    const i3 = nn(o2, M(o2, s), `${n3} ${t}`);
    i3 && (r2 = i3);
  }), r2;
}
function rn(e, n3) {
  let t = null;
  return j(e) ? e.forEach((r2) => {
    t || en(r2) || (t = U("UNSUPPORTED_ACCOUNTS", `${n3}, account ${r2} should be a string and conform to "namespace:chainId:address" format`));
  }) : t = U("UNSUPPORTED_ACCOUNTS", `${n3}, accounts should be an array of strings conforming to "namespace:chainId:address" format`), t;
}
function on(e, n3) {
  let t = null;
  return Object.values(e).forEach((r2) => {
    if (t)
      return;
    const o2 = rn(r2 == null ? void 0 : r2.accounts, `${n3} namespace`);
    o2 && (t = o2);
  }), t;
}
function sn(e, n3) {
  let t = null;
  return ie(e == null ? void 0 : e.methods) ? ie(e == null ? void 0 : e.events) || (t = U("UNSUPPORTED_EVENTS", `${n3}, events should be an array of strings or empty array for no events`)) : t = U("UNSUPPORTED_METHODS", `${n3}, methods should be an array of strings or empty array for no methods`), t;
}
function ce(e, n3) {
  let t = null;
  return Object.values(e).forEach((r2) => {
...
function Kt(e, n3) {
  let t = false;
  return n3 && !e ? t = true : e && j(e) && e.length && e.forEach((r2) => {
    t = an(r2);
  }), t;
}
function Lt(e) {
...
function Gt(e, n3) {
  return !(!D(n3) || !Je(e).includes(n3));
}
function Wt(e, n3, t) {
  return h2(t, false) ? Qe(e, n3).includes(t) : false;
}
function zt(e, n3, t) {
  return h2(t, false) ? Ze(e, n3).includes(t) : false;
}
function un(e, n3, t) {
  let r2 = null;
  const o2 = Yt(e), s = Jt(n3), i3 = Object.keys(o2), l2 = Object.keys(s), d3 = ln(Object.keys(e)), c2 = ln(Object.keys(n3)), u3 = d3.filter((a3) => !c2.includes(a3));
  return u3.length && (r2 = N("NON_CONFORMING_NAMESPACES", `${t} namespaces keys don't satisfy requiredNamespaces.
      Required: ${u3.toString()}
      Received: ${Object.keys(n3).toString()}`)), O(i3, l2) || (r2 = N("NON_CONFORMING_NAMESPACES", `${t} namespaces chains don't satisfy required namespaces.
      Required: ${i3.toString()}
      Approved: ${l2.toString()}`)), Object.keys(n3).forEach((a3) => {
    if (!a3.includes(":") || r2)
      return;
    const b3 = A(n3[a3].accounts);
    b3.includes(a3) || (r2 = N("NON_CONFORMING_NAMESPACES", `${t} namespaces accounts don't satisfy namespace accounts for ${a3}
        Required: ${a3}
...
function Qt(e, n3) {
  return G(e, false) && e <= n3.max && e >= n3.min;
}
function Zt() {
  const e = R();
...
function yn(e) {
  H() && typeof global < "u" && global != null && global.NetInfo && (global == null ? void 0 : global.NetInfo.addEventListener((n3) => e(n3 == null ? void 0 : n3.isConnected)));
}
var ae = {};
var er = class {
  static get(n3) {
...
function ki(r2, e) {
  ...
  var o2 = r2.length, h4 = r2.charAt(0), l2 = Math.log(o2) / Math.log(256), d3 = Math.log(256) / Math.log(o2);
  function p5(c2) {
    ...
    if (c2.length === 0)
      return "";
    for (var b3 = 0, z2 = 0, v = 0, _3 = c2.length; v !== _3 && c2[v] === 0; )
      v++, b3++;
    for (var T2 = (_3 - v) * d3 + 1 >>> 0, m3 = new Uint8Array(T2); v !== _3; ) {
      for (var S3 = c2[v], A3 = 0, I = T2 - 1; (S3 !== 0 || A3 < z2) && I !== -1; I--, A3++)
        S3 += 256 * m3[I] >>> 0, m3[I] = S3 % o2 >>> 0, S3 = S3 / o2 >>> 0;
      if (S3 !== 0)
        throw new Error("Non-zero carry");
      z2 = A3, v++;
    }
    for (var O3 = T2 - z2; O3 !== T2 && m3[O3] === 0; )
      O3++;
    for (var V2 = h4.repeat(b3); O3 < T2; ++O3)
      V2 += r2.charAt(m3[O3]);
    return V2;
  }
  function y5(c2) {
    ...
    var b3 = 0;
    if (c2[b3] !== " ") {
      for (var z2 = 0, v = 0; c2[b3] === h4; )
        z2++, b3++;
      for (var _3 = (c2.length - b3) * l2 + 1 >>> 0, T2 = new Uint8Array(_3); c2[b3]; ) {
        var m3 = t[c2.charCodeAt(b3)];
        if (m3 === 255)
          return;
        for (var S3 = 0, A3 = _3 - 1; (m3 !== 0 || S3 < v) && A3 !== -1; A3--, S3++)
          m3 += o2 * T2[A3] >>> 0, T2[A3] = m3 % 256 >>> 0, m3 = m3 / 256 >>> 0;
        if (m3 !== 0)
          throw new Error("Non-zero carry");
        v = S3, b3++;
      }
      if (c2[b3] !== " ") {
        for (var I = _3 - v; I !== _3 && T2[I] === 0; )
          I++;
        for (var O3 = new Uint8Array(z2 + (_3 - I)), V2 = z2; I !== _3; )
          O3[V2++] = T2[I++];
        return O3;
      }
    }
  ...
  return { encode: p5, decodeUnsafe: y5, decode: $2 };
}
var Ki = ki;
var Bi = Ki;
var Ae2 = (r2) => {
...
var ze = (r2, e) => new Gi({ ...r2.decoders || { [r2.prefix]: r2 }, ...e.decoders || { [e.prefix]: e } });
var Hi = class {
  constructor(e, t, i3, s) {
    this.name = e, this.prefix = t, this.baseEncode = i3, this.baseDecode = s, this.encoder = new ji(e, t, i3), this.decoder = new Yi(e, t, s);
  }
  encode(e) {
...
var J2 = ({ name: r2, prefix: e, encode: t, decode: i3 }) => new Hi(r2, e, t, i3);
var K = ({ prefix: r2, name: e, alphabet: t }) => {
  const { encode: i3, decode: s } = Bi(t, e);
  return J2({ prefix: r2, name: e, encode: i3, decode: (n3) => Ae2(s(n3)) });
};
var Ji = (r2, e, t, i3) => {
  const s = {};
  ...
  for (let d3 = 0; d3 < n3; ++d3) {
    ...
    h4 = h4 << t | p5, o2 += t, o2 >= 8 && (o2 -= 8, a3[l2++] = 255 & h4 >> o2);
  }
  if (o2 >= t || 255 & h4 << 8 - o2)
    throw new SyntaxError("Unexpected end of data");
  return a3;
...
var g2 = ({ name: r2, prefix: e, bitsPerChar: t, alphabet: i3 }) => J2({ prefix: e, name: r2, encode(s) {
  return Wi(s, i3, t);
}, decode(s) {
  return Ji(s, i3, t, r2);
} });
...
var Ne = Array.from("🚀🪐☄🛰🌌🌑🌒🌓🌔🌕🌖🌗🌘🌍🌏🌎🐉☀💻🖥💾💿😂❤😍🤣😊🙏💕😭😘👍😅👏😁🔥🥰💔💖💙😢🤔😆🙄💪😉☺👌🤗💜😔😎😇🌹🤦🎉💞✌✨🤷😱😌🌸🙌😋💗💚😏💛🙂💓🤩😄😀🖤😃💯🙈👇🎶😒🤭❣😜💋👀😪😑💥🙋😞😩😡🤪👊🥳😥🤤👉💃😳✋😚😝😴🌟😬🙃🍀🌷😻😓⭐✅🥺🌈😈🤘💦✔😣🏃💐☹🎊💘😠☝😕🌺🎂🌻😐🖕💝🙊😹🗣💫💀👑🎵🤞😛🔴😤🌼😫⚽🤙☕🏆🤫👈😮🙆🍻🍃🐶💁😲🌿🧡🎁⚡🌞🎈❌✊👋😰🤨😶🤝🚶💰🍓💢🤟🙁🚨💨🤬✈🎀🍺🤓😙💟🌱😖👶🥴▶➡❓💎💸⬇😨🌚🦋😷🕺⚠🙅😟😵👎🤲🤠🤧📌🔵💅🧐🐾🍒😗🤑🌊🤯🐷☎💧😯💆👆🎤🙇🍑❄🌴💣🐸💌📍🥀🤢👅💡💩👐📸👻🤐🤮🎼🥵🚩🍎🍊👼💍📣🥂");
var Ps = Ne.reduce((r2, e, t) => (r2[t] = e, r2), []);
var Os = Ne.reduce((r2, e, t) => (r2[e.codePointAt(0)] = t, r2), []);
function xs(r2) {
  return r2.reduce((e, t) => (e += Ps[t], e), "");
}
function As(r2) {
  const e = [];
  for (const t of r2) {
...
function Ue2(r2, e, t) {
  e = e || [], t = t || 0;
  for (var i3 = t; r2 >= $s; )
    e[t++] = r2 & 255 | Le, r2 /= 128;
  for (; r2 & Fs; )
    e[t++] = r2 & 255 | Le, r2 >>>= 7;
  return e[t] = r2 | 0, Ue2.bytes = t - i3 + 1, e;
}
var Ms = ae2;
var ks = 128;
var Fe2 = 127;
function ae2(r2, i3) {
  ...
  do {
    ...
    a3 = r2[n3++], t += s < 28 ? (a3 & Fe2) << s : (a3 & Fe2) * Math.pow(2, s), s += 7;
  } while (a3 >= ks);
...
var $e = Xs;
var Me2 = (r2, e, t = 0) => ($e.encode(r2, e, t), e);
var ke2 = (r2) => $e.encodingLength(r2);
var oe = (r2, e) => {
  const t = e.byteLength, i3 = ke2(r2), s = i3 + ke2(t), n3 = new Uint8Array(s + t);
  return Me2(r2, n3, 0), Me2(t, n3, i3), n3.set(e, s), new Qs(r2, t, e, n3);
};
var Qs = class {
  constructor(e, t, i3, s) {
...
var Ke = ({ name: r2, code: e, encode: t }) => new Zs(r2, e, t);
var Zs = class {
  constructor(e, t, i3) {
...
var Be2 = (r2) => async (e) => new Uint8Array(await crypto.subtle.digest(r2, e));
...
var he2 = Ge2("ascii", "a", (r2) => {
  ...
  r2 = r2.substring(1);
  const e = or2(r2.length);
  for (let t = 0; t < r2.length; t++)
    e[t] = r2.charCodeAt(t);
  return e;
});
var hr = { utf8: He2, "utf-8": He2, hex: je2.base16, latin1: he2, ascii: he2, binary: he2, ...je2 };
function cr(r2, e = "utf8") {
  const t = hr[e];
  if (!t)
    throw new Error(`Unsupported encoding "${e}"`);
  return (e === "utf8" || e === "utf-8") && globalThis.Buffer != null && globalThis.Buffer.from != null ? Ye(globalThis.Buffer.from(r2, "utf-8")) : t.decoder.decode(`${t.prefix}${r2}`);
}
var ce2 = "wc";
var Je2 = 2;
var W2 = "core";
...
var Rt = class {
  constructor(e, t, i3) {
    this.core = e, this.logger = t, this.name = Qe2, this.initialized = false, this.init = async () => {
      ...
      this.isInitialized();
      const n3 = await this.getClientSeed(), a3 = generateKeyPair(n3), o2 = Dn(), h4 = Ze2;
      return await signJWT(o2, s, h4, a3);
    }, this.generateSharedKey = (s, n3, a3) => {
      this.isInitialized();
      const o2 = this.getPrivateKey(s), h4 = kn(o2, n3);
      return this.setSymKey(h4, a3);
      ...
      this.isInitialized();
      const o2 = Re(a3), h4 = safeJsonStringify(n3);
      if (Fn(o2)) {
        const y5 = o2.senderPublicKey, $2 = o2.receiverPublicKey;
        s = await this.generateSharedKey(y5, $2);
      }
      const l2 = this.getSymKey(s), { type: d3, senderPublicKey: p5 } = o2;
      return Kn({ type: d3, symKey: l2, message: h4, senderPublicKey: p5 });
    }, this.decode = async (s, n3, a3) => {
      this.isInitialized();
      const o2 = xn(n3, a3);
      if (Fn(o2)) {
        const h4 = o2.receiverPublicKey, l2 = o2.senderPublicKey;
        s = await this.generateSharedKey(h4, l2);
      }
      try {
        const h4 = this.getSymKey(s), l2 = Ln({ symKey: h4, encoded: n3 });
    ...
    }, this.core = e, this.logger = (0, import_logger.generateChildLogger)(t, this.name), this.keychain = i3 || new Ct2(this.core, this.logger);
  }
  get context() {
    return (0, import_logger.getLoggerContext)(this.logger);
  }
...
var pr = class extends u {
  constructor(e, t) {
    super(e, t), this.relayer = e, this.logger = t, this.events = new import_events5.EventEmitter(), this.name = nt2, this.queue = /* @__PURE__ */ new Map(), this.publishTimeout = (0, import_time3.toMiliseconds)(import_time3.TEN_SECONDS), this.needsTransportRestart = false, this.publish = async (i3, s, n3) => {
      var a3;
      this.logger.debug("Publishing Payload"), this.logger.trace({ type: "method", method: "publish", params: { topic: i3, message: s, opts: n3 } });
      try {
        const o2 = (n3 == null ? void 0 : n3.ttl) || rt, h4 = mt(n3), l2 = (n3 == null ? void 0 : n3.prompt) || false, d3 = (n3 == null ? void 0 : n3.tag) || 0, p5 = (n3 == null ? void 0 : n3.id) || getBigIntRpcId().toString(), y5 = { topic: i3, message: s, opts: { ttl: o2, relay: h4, prompt: l2, tag: d3, id: p5 } }, $2 = setTimeout(() => this.queue.set(p5, y5), this.publishTimeout);
        try {
          await await it(this.rpcPublish(i3, s, o2, h4, l2, d3, p5), this.publishTimeout, "Failed to publish payload, please try again."), this.removeRequestFromQueue(p5), this.relayer.events.emit(D2.publish, y5);
        } catch (c2) {
          if (this.logger.debug("Publishing Payload stalled"), this.needsTransportRestart = true, (a3 = n3 == null ? void 0 : n3.internal) != null && a3.throwOnFailedPublish)
            throw this.removeRequestFromQueue(p5), c2;
          return;
        } finally {
          clearTimeout($2);
        }
  ...
  rpcPublish(e, t, i3, s, n3, a3, o2) {
    var h4, l2, d3, p5;
    const y5 = { method: yt(s.protocol).publish, params: { topic: e, message: t, ttl: i3, prompt: n3, tag: a3 }, id: o2 };
    return w((h4 = y5.params) == null ? void 0 : h4.prompt) && ((l2 = y5.params) == null || delete l2.prompt), w((d3 = y5.params) == null ? void 0 : d3.tag) && ((p5 = y5.params) == null || delete p5.tag), this.logger.debug("Outgoing Relay Payload"), this.logger.trace({ type: "message", direction: "outgoing", request: y5 }), this.relayer.request(y5);
  }
...
var St = (r2, e, t) => e in r2 ? yr(r2, e, { enumerable: true, configurable: true, writable: true, value: t }) : r2[e] = t;
var B2 = (r2, e) => {
  for (var t in e || (e = {}))
    fr.call(e, t) && St(r2, t, e[t]);
  if (Tt)
    for (var t of Tt(e))
      Er.call(e, t) && St(r2, t, e[t]);
  return r2;
};
var pe = (r2, e) => br(r2, mr(e));
var Pt = class extends d2 {
  constructor(e, t) {
    super(e, t), this.relayer = e, this.logger = t, this.subscriptions = /* @__PURE__ */ new Map(), this.topicMap = new Dr(), this.events = new import_events5.EventEmitter(), this.name = Dt2, this.version = yt2, this.pending = /* @__PURE__ */ new Map(), this.cached = [], this.initialized = false, this.pendingSubscriptionWatchLabel = "pending_sub_watch_label", this.pollingInterval = 20, this.storagePrefix = x2, this.subscribeTimeout = 1e4, this.restartInProgress = false, this.batchSubscribeTopicsLimit = 500, this.init = async () => {
      ...
      try {
        const n3 = mt(s), a3 = { topic: i3, relay: n3 };
      ...
      const o2 = setInterval(() => {
        !this.pending.has(i3) && this.topics.includes(i3) && (clearInterval(o2), a3.stop(this.pendingSubscriptionWatchLabel), s(true)), a3.elapsed(this.pendingSubscriptionWatchLabel) >= bt2 && (clearInterval(o2), a3.stop(this.pendingSubscriptionWatchLabel), n3(new Error("Subscription resolution timeout")));
  ...
  async rpcBatchSubscribe(e) {
    if (!e.length)
      return;
    const t = e[0].relay, i3 = { method: yt(t.protocol).batchSubscribe, params: { topics: e.map((s) => s.topic) } };
    this.logger.debug("Outgoing Relay Payload"), this.logger.trace({ type: "payload", direction: "outgoing", request: i3 });
    try {
  ...
  rpcUnsubscribe(e, t, i3) {
    const s = { method: yt(i3.protocol).unsubscribe, params: { topic: e, id: t } };
  ...
  deleteSubscription(e, t) {
    ...
    this.subscriptions.delete(e), this.topicMap.delete(i3.topic, e), this.events.emit(C.deleted, pe(B2({}, i3), { reason: t }));
  }
  async persist() {
  ...
  async batchSubscribe(e) {
    ...
    j(t) && this.onBatchSubscribe(t.map((i3, s) => pe(B2({}, e[s]), { id: i3 })));
  }
  async onConnect() {
...
var xt2 = (r2, e, t) => e in r2 ? wr(r2, e, { enumerable: true, configurable: true, writable: true, value: t }) : r2[e] = t;
var Cr = (r2, e) => {
  for (var t in e || (e = {}))
    vr.call(e, t) && xt2(r2, t, e[t]);
  if (Ot)
    for (var t of Ot(e))
      Ir.call(e, t) && xt2(r2, t, e[t]);
  return r2;
};
var At2 = class extends g {
  ...
  async subscribe(e, t) {
    ...
    return s || (await Promise.all([new Promise((n3) => {
      this.subscriber.once(C.created, (a3) => {
        a3.topic === e && n3();
      });
  ...
  async onProviderPayload(e) {
    if (this.logger.debug("Incoming Relay Payload"), this.logger.trace({ type: "payload", direction: "incoming", payload: e }), isJsonRpcRequest(e)) {
      ...
      this.logger.debug("Emitting Relayer Payload"), this.logger.trace(Cr({ type: "event", event: t.id }, a3)), this.events.emit(t.id, a3), await this.acknowledgePayload(e), await this.onMessageEvent(a3);
    } else
...
var Nt2 = (r2, e, t) => e in r2 ? Rr(r2, e, { enumerable: true, configurable: true, writable: true, value: t }) : r2[e] = t;
var Lt2 = (r2, e) => {
  for (var t in e || (e = {}))
    _r.call(e, t) && Nt2(r2, t, e[t]);
  if (zt2)
    for (var t of zt2(e))
      Tr.call(e, t) && Nt2(r2, t, e[t]);
  return r2;
};
var Ut = class extends p2 {
  constructor(e, t, i3, s = x2, n3 = void 0) {
    super(e, t, i3, s), this.core = e, this.logger = t, this.name = i3, this.map = /* @__PURE__ */ new Map(), this.version = gt2, this.cached = [], this.initialized = false, this.storagePrefix = x2, this.init = async () => {
      this.initialized || (this.logger.trace("Initialized"), await this.restore(), this.cached.forEach((a3) => {
        this.getKey && a3 !== null && !w(a3) ? this.map.set(this.getKey(a3), a3) : Dt(a3) ? this.map.set(a3.id, a3) : kt(a3) && this.map.set(a3.topic, a3);
      }), this.cached = [], this.initialized = true);
    ...
    }, this.get = (a3) => (this.isInitialized(), this.logger.debug("Getting value"), this.logger.trace({ type: "method", method: "get", key: a3 }), this.getData(a3)), this.getAll = (a3) => (this.isInitialized(), a3 ? this.values.filter((o2) => Object.keys(a3).every((h4) => (0, import_lodash.default)(o2[h4], a3[h4]))) : this.values), this.update = async (a3, o2) => {
      this.isInitialized(), this.logger.debug("Updating value"), this.logger.trace({ type: "method", method: "update", key: a3, update: o2 });
      const h4 = Lt2(Lt2({}, this.getData(a3)), o2);
      this.map.set(a3, h4), await this.persist();
...
var Ft2 = class {
  constructor(e, t) {
    this.core = e, this.logger = t, this.name = mt2, this.version = ft2, this.events = new import_events5.default(), this.initialized = false, this.storagePrefix = x2, this.ignoredPayloadTypes = [_], this.registeredMethods = [], this.init = async () => {
      ...
      this.isInitialized();
      const i3 = Dn(), s = await this.core.crypto.setSymKey(i3), n3 = lt(import_time3.FIVE_MINUTES), a3 = { protocol: at2 }, o2 = { topic: s, expiry: n3, relay: a3, active: false }, h4 = Nt({ protocol: this.core.protocol, version: this.core.version, topic: s, symKey: i3, relay: a3 });
      return await this.pairings.set(s, o2), await this.core.relayer.subscribe(s), this.core.expirer.set(s, n3), { topic: s, uri: h4 };
    }, this.pair = async (i3) => {
      this.isInitialized(), this.isValidPair(i3);
      const { topic: s, symKey: n3, relay: a3 } = bt(i3.uri);
      if (this.pairings.keys.includes(s))
        throw new Error(`Pairing already exists: ${s}`);
      if (this.core.crypto.hasKeys(s))
        throw new Error(`Keychain already exists: ${s}`);
      const o2 = lt(import_time3.FIVE_MINUTES), h4 = { topic: s, relay: a3, expiry: o2, active: false };
      return await this.pairings.set(s, h4), await this.core.crypto.setSymKey(n3, s), await this.core.relayer.subscribe(s, { relay: a3 }), this.core.expirer.set(s, o2), i3.activatePairing && await this.activate({ topic: s }), h4;
      ...
      const { topic: s } = i3;
      if (this.pairings.keys.includes(s)) {
        const n3 = await this.sendRequest(s, "wc_pairingPing", {}), { done: a3, resolve: o2, reject: h4 } = st();
        this.events.once(ft("pairing_ping", n3), ({ error: l2 }) => {
          l2 ? h4(l2) : o2();
        }), await a3();
      }
      ...
      const a3 = formatJsonRpcRequest(s, n3), o2 = await this.core.crypto.encode(i3, a3), h4 = F[s].req;
      return this.core.history.set(i3, a3), this.core.relayer.publish(i3, o2, h4), a3.id;
    }, this.sendResult = async (i3, s, n3) => {
      const a3 = formatJsonRpcResult(i3, n3), o2 = await this.core.crypto.encode(s, a3), h4 = await this.core.history.get(s, i3), l2 = F[h4.request.method].res;
      await this.core.relayer.publish(s, o2, l2), await this.core.history.resolve(a3);
    }, this.sendError = async (i3, s, n3) => {
      const a3 = formatJsonRpcError(i3, n3), o2 = await this.core.crypto.encode(s, a3), h4 = await this.core.history.get(s, i3), l2 = F[h4.request.method] ? F[h4.request.method].res : F.unregistered_method.res;
      await this.core.relayer.publish(s, o2, l2), await this.core.history.resolve(a3);
      ...
      const { id: n3 } = s;
      setTimeout(() => {
        isJsonRpcResult(s) ? this.events.emit(ft("pairing_ping", n3), {}) : isJsonRpcError(s) && this.events.emit(ft("pairing_ping", n3), { error: s.error });
      }, 500);
      ...
      try {
        if (this.registeredMethods.includes(a3))
          return;
        const o2 = U("WC_METHOD_UNSUPPORTED", a3);
  ...
  constructor(e, t) {
    super(e, t), this.core = e, this.logger = t, this.records = /* @__PURE__ */ new Map(), this.events = new import_events5.EventEmitter(), this.name = Et2, this.version = wt, this.cached = [], this.initialized = false, this.storagePrefix = x2, this.init = async () => {
      ...
      if (this.isInitialized(), this.logger.debug("Setting JSON-RPC request history record"), this.logger.trace({ type: "method", method: "set", topic: i3, request: s, chainId: n3 }), this.records.has(s.id))
        return;
      const a3 = { id: s.id, topic: i3, request: { method: s.method, params: s.params || null }, chainId: n3, expiry: lt(import_time3.THIRTY_DAYS) };
...
var kt2 = class extends y2 {
  constructor(e, t) {
    super(e, t), this.projectId = e, this.logger = t, this.name = X2, this.initialized = false, this.queue = [], this.verifyDisabled = false, this.init = async (i3) => {
      if (this.verifyDisabled || H() || !q())
        return;
      const s = (i3 == null ? void 0 : i3.verifyUrl) || Q2;
      this.verifyUrl !== s && this.removeIframe(), this.verifyUrl = s;
      try {
        await this.createIframe();
      } catch (n3) {
        this.logger.warn(`Verify iframe failed to load: ${this.verifyUrl}`), this.logger.warn(n3);
      }
      if (!this.initialized) {
        ...
        try {
          ...
          this.logger.error(`Verify iframe failed to load: ${this.verifyUrl}`), this.logger.error(n3), this.verifyDisabled = true;
        }
      }
      ...
      let n3 = "";
      try {
        n3 = await this.fetchAttestation(i3.attestationId, s);
      } catch (a3) {
        this.logger.warn(`failed to resolve attestation: ${i3.attestationId} from url: ${s}`), this.logger.warn(a3), n3 = await this.fetchAttestation(i3.attestationId, ge);
      }
      return n3;
    }, this.fetchAttestation = async (i3, s) => {
      var n3;
      this.logger.info(`resolving attestation: ${i3} from url: ${s}`);
      const a3 = this.startAbortTimer(import_time3.ONE_SECOND * 2), o2 = await fetch(`${s}/attestation/${i3}`, { signal: this.abortController.signal });
      return clearTimeout(a3), o2.status === 200 ? (n3 = await o2.json()) == null ? void 0 : n3.origin : "";
    }, this.addToQueue = (i3) => {
      this.queue.push(i3);
    }, this.processQueue = () => {
      ...
      let i3;
      const s = (n3) => {
        n3.data === "verify_ready" && (this.initialized = true, this.processQueue(), window.removeEventListener("message", s), i3());
      };
      await Promise.race([new Promise((n3) => {
        ...
        a3.id = X2, a3.src = `${this.verifyUrl}/${this.projectId}`, a3.style.display = "none", document.body.append(a3), this.iframe = a3, i3 = n3;
      }), new Promise((n3, a3) => setTimeout(() => {
...
var Bt2 = (r2, e, t) => e in r2 ? Sr(r2, e, { enumerable: true, configurable: true, writable: true, value: t }) : r2[e] = t;
var Vt2 = (r2, e) => {
  for (var t in e || (e = {}))
    Pr.call(e, t) && Bt2(r2, t, e[t]);
  if (Kt2)
    for (var t of Kt2(e))
      Or.call(e, t) && Bt2(r2, t, e[t]);
  return r2;
};
var Z2 = class extends n {
  constructor(e) {
    super(e), this.protocol = ce2, this.version = Je2, this.name = W2, this.events = new import_events5.EventEmitter(), this.initialized = false, this.on = (i3, s) => this.events.on(i3, s), this.once = (i3, s) => this.events.once(i3, s), this.off = (i3, s) => this.events.off(i3, s), this.removeListener = (i3, s) => this.events.removeListener(i3, s), this.projectId = e == null ? void 0 : e.projectId, this.relayUrl = (e == null ? void 0 : e.relayUrl) || le2;
  ...
  static async init(e) {
    ...
    return await t.storage.setItem(pt2, i3), t;
  }
  get context() {
    return (0, import_logger.getLoggerContext)(this.logger);
  }
...
var de3 = (m3, r2, e) => r2 in m3 ? rs2(m3, r2, { enumerable: true, configurable: true, writable: true, value: e }) : m3[r2] = e;
var g3 = (m3, r2) => {
  for (var e in r2 || (r2 = {}))
    as2.call(r2, e) && de3(m3, e, r2[e]);
  if (he3)
    for (var e of he3(r2))
      cs2.call(r2, e) && de3(m3, e, r2[e]);
  return m3;
};
var b2 = (m3, r2) => ns2(m3, os2(r2));
var ls2 = class extends S {
  constructor(r2) {
    super(r2), this.name = ce3, this.events = new import_events6.default(), this.initialized = false, this.ignoredPayloadTypes = [_], this.requestQueue = { state: E3.idle, queue: [] }, this.sessionRequestQueue = { state: E3.idle, queue: [] }, this.requestQueueDelay = import_time4.ONE_SECOND, this.init = async () => {
      ...
      let l2 = t, p5, d3 = false;
      if (l2 && (d3 = this.client.core.pairing.pairings.get(l2).active), !l2 || !d3) {
        const { topic: v, uri: S3 } = await this.client.core.pairing.create();
        l2 = v, p5 = S3;
      }
      const h4 = await this.client.core.crypto.generateKeyPair(), I = g3({ requiredNamespaces: i3, optionalNamespaces: n3, relays: a3 ?? [{ protocol: at2 }], proposer: { publicKey: h4, metadata: this.client.metadata } }, o2 && { sessionProperties: o2 }), { reject: w4, resolve: T2, done: K2 } = st(import_time4.FIVE_MINUTES, oe2);
      if (this.events.once(ft("session_connect"), async ({ error: v, session: S3 }) => {
        if (v)
          w4(v);
        else if (S3) {
          S3.self.publicKey = h4;
          const W4 = b2(g3({}, S3), { requiredNamespaces: S3.requiredNamespaces, optionalNamespaces: S3.optionalNamespaces });
          await this.client.session.set(S3.topic, W4), await this.setExpiry(S3.topic, S3.expiry), l2 && await this.client.core.pairing.updateMetadata({ topic: l2, metadata: S3.peer.metadata }), T2(W4);
        }
      }), !l2) {
        const { message: v } = N("NO_MATCHING_KEY", `connect() pairing topic: ${l2}`);
        throw new Error(v);
      }
      const L3 = await this.sendRequest({ topic: l2, method: "wc_sessionPropose", params: I }), ue3 = lt(import_time4.FIVE_MINUTES);
      return await this.setProposal(L3, g3({ id: L3, expiry: ue3 }, I)), { uri: p5, approval: K2 };
      ...
      let { pairingTopic: a3, proposer: l2, requiredNamespaces: p5, optionalNamespaces: d3 } = o2;
      a3 = a3 || "", B(p5) || (p5 = At(i3, "approve()"));
      const h4 = await this.client.core.crypto.generateKeyPair(), I = l2.publicKey, w4 = await this.client.core.crypto.generateSharedKey(h4, I);
      a3 && s && (await this.client.core.pairing.updateMetadata({ topic: a3, metadata: l2.metadata }), await this.sendResult({ id: s, topic: a3, result: { relay: { protocol: t ?? "irn" }, responderPublicKey: h4 } }), await this.client.proposal.delete(s, U("USER_DISCONNECTED")), await this.client.core.pairing.activate({ topic: a3 }));
      const T2 = g3({ relay: { protocol: t ?? "irn" }, namespaces: i3, requiredNamespaces: p5, optionalNamespaces: d3, pairingTopic: a3, controller: { publicKey: h4, metadata: this.client.metadata }, expiry: lt(C2) }, n3 && { sessionProperties: n3 });
      ...
      const K2 = b2(g3({}, T2), { topic: w4, pairingTopic: a3, acknowledged: false, self: T2.controller, peer: { publicKey: l2.publicKey, metadata: l2.metadata }, controller: h4 });
      return await this.client.session.set(w4, K2), await this.setExpiry(w4, lt(C2)), { topic: w4, acknowledged: () => new Promise((L3) => setTimeout(() => L3(this.client.session.get(w4)), 500)) };
    }, this.reject = async (e) => {
      await this.isInitialized(), await this.isValidReject(e);
      const { id: s, reason: t } = e, { pairingTopic: i3 } = this.client.proposal.get(s);
      i3 && (await this.sendError(s, i3, t), await this.client.proposal.delete(s, U("USER_DISCONNECTED")));
    }, this.update = async (e) => {
      await this.isInitialized(), await this.isValidUpdate(e);
      const { topic: s, namespaces: t } = e, i3 = await this.sendRequest({ topic: s, method: "wc_sessionUpdate", params: { namespaces: t } }), { done: n3, resolve: o2, reject: a3 } = st();
      return this.events.once(ft("session_update", i3), ({ error: l2 }) => {
        l2 ? a3(l2) : o2();
      }), await this.client.session.update(s, { namespaces: t }), { acknowledged: n3 };
    }, this.extend = async (e) => {
      await this.isInitialized(), await this.isValidExtend(e);
      const { topic: s } = e, t = await this.sendRequest({ topic: s, method: "wc_sessionExtend", params: {} }), { done: i3, resolve: n3, reject: o2 } = st();
      return this.events.once(ft("session_extend", t), ({ error: a3 }) => {
        a3 ? o2(a3) : n3();
      }), await this.setExpiry(s, lt(C2)), { acknowledged: i3 };
    }, this.request = async (e) => {
      await this.isInitialized(), await this.isValidRequest(e);
      const { chainId: s, request: t, topic: i3, expiry: n3 } = e, o2 = payloadId(), { done: a3, resolve: l2, reject: p5 } = st(n3);
      return this.events.once(ft("session_request", o2), ({ error: d3, result: h4 }) => {
        d3 ? p5(d3) : l2(h4);
      }), await Promise.all([new Promise(async (d3) => {
        await this.sendRequest({ clientRpcId: o2, topic: i3, method: "wc_sessionRequest", params: { request: t, chainId: s }, expiry: n3, throwOnFailedPublish: true }).catch((h4) => p5(h4)), this.client.events.emit("session_request_sent", { topic: i3, request: t, chainId: s, id: o2 }), d3();
      }), new Promise(async (d3) => {
        const h4 = await this.client.core.storage.getItem(H3);
        pt({ id: o2, topic: i3, wcDeepLink: h4 }), d3();
      }), a3()]).then((d3) => d3[2]);
      ...
      if (this.client.session.keys.includes(s)) {
        const t = await this.sendRequest({ topic: s, method: "wc_sessionPing", params: {} }), { done: i3, resolve: n3, reject: o2 } = st();
        this.events.once(ft("session_ping", t), ({ error: a3 }) => {
          a3 ? o2(a3) : n3();
        }), await i3();
      } else
      ...
      await Promise.all([this.client.pendingRequest.delete(e, s), t ? Promise.resolve() : this.client.core.expirer.del(e)]), this.sessionRequestQueue.queue = this.sessionRequestQueue.queue.filter((i3) => i3.id !== e), t && (this.sessionRequestQueue.state = E3.idle);
      ...
      const s = V.wc_sessionRequest.req.ttl, { id: t, topic: i3, params: n3 } = e;
      await this.client.pendingRequest.set(t, { id: t, topic: i3, params: n3 }), s && this.client.core.expirer.set(t, lt(s));
    }, this.sendRequest = async (e) => {
      const { topic: s, method: t, params: i3, expiry: n3, relayRpcId: o2, clientRpcId: a3, throwOnFailedPublish: l2 } = e, p5 = formatJsonRpcRequest(t, i3, a3);
      if (q() && pe2.includes(t)) {
        const I = Mn(JSON.stringify(p5));
        this.client.core.verify.register({ attestationId: I });
      }
      const d3 = await this.client.core.crypto.encode(s, p5), h4 = V[t].req;
      return n3 && (h4.ttl = n3), o2 && (h4.id = o2), this.client.core.history.set(s, p5), l2 ? (h4.internal = b2(g3({}, h4.internal), { throwOnFailedPublish: true }), await this.client.core.relayer.publish(s, d3, h4)) : this.client.core.relayer.publish(s, d3, h4).catch((I) => this.client.logger.error(I)), p5.id;
    }, this.sendResult = async (e) => {
      const { id: s, topic: t, result: i3, throwOnFailedPublish: n3 } = e, o2 = formatJsonRpcResult(s, i3), a3 = await this.client.core.crypto.encode(t, o2), l2 = await this.client.core.history.get(t, s), p5 = V[l2.request.method].res;
      n3 ? (p5.internal = b2(g3({}, p5.internal), { throwOnFailedPublish: true }), await this.client.core.relayer.publish(t, a3, p5)) : this.client.core.relayer.publish(t, a3, p5).catch((d3) => this.client.logger.error(d3)), await this.client.core.history.resolve(o2);
    }, this.sendError = async (e, s, t) => {
      const i3 = formatJsonRpcError(e, t), n3 = await this.client.core.crypto.encode(s, i3), o2 = await this.client.core.history.get(s, e), a3 = V[o2.request.method].res;
      ...
      try {
        ...
        const n3 = lt(import_time4.FIVE_MINUTES), o2 = g3({ id: i3, pairingTopic: e, expiry: n3 }, t);
        await this.setProposal(i3, o2);
        const a3 = Mn(JSON.stringify(s)), l2 = await this.getVerifyContext(a3, o2.proposer.metadata);
      ...
      if (isJsonRpcResult(s)) {
        ...
        const p5 = await this.client.core.relayer.subscribe(l2);
      ...
      try {
        ...
        const { relay: n3, controller: o2, expiry: a3, namespaces: l2, requiredNamespaces: p5, optionalNamespaces: d3, sessionProperties: h4, pairingTopic: I } = s.params, w4 = g3({ topic: e, relay: n3, expiry: a3, namespaces: l2, acknowledged: true, pairingTopic: I, requiredNamespaces: p5, optionalNamespaces: d3, controller: o2.publicKey, self: { publicKey: "", metadata: this.client.metadata }, peer: { publicKey: o2.publicKey, metadata: o2.metadata } }, h4 && { sessionProperties: h4 });
        await this.sendResult({ id: s.id, topic: e, result: true }), this.events.emit(ft("session_connect"), { session: w4 }), this.cleanupDuplicatePairings(w4);
      } catch (n3) {
      ...
      const { params: t, id: i3 } = s;
      try {
        const n3 = `${e}_session_update`, o2 = er.get(n3);
        if (o2 && this.isRequestOutOfSync(o2, i3)) {
          this.client.logger.info(`Discarding out of sync request - ${i3}`);
          return;
        }
        this.isValidUpdate(g3({ topic: e }, t)), await this.client.session.update(e, { namespaces: t.namespaces }), await this.sendResult({ id: i3, topic: e, result: true }), this.client.events.emit("session_update", { id: i3, topic: e, params: t }), er.set(n3, i3);
      } catch (n3) {
        await this.sendError(i3, e, n3), this.client.logger.error(n3);
      }
      ...
      const { id: t, params: i3 } = s;
      try {
        this.isValidRequest(g3({ topic: e }, i3)), await this.setPendingSessionRequest({ id: t, topic: e, params: i3 }), this.addSessionRequestToSessionRequestQueue({ id: t, topic: e, params: i3 }), await this.processSessionRequestQueue();
      } catch (n3) {
        await this.sendError(t, e, n3), this.client.logger.error(n3);
      }
      ...
      const { id: t, params: i3 } = s;
      try {
        const n3 = `${e}_session_event_${i3.event.name}`, o2 = er.get(n3);
        if (o2 && this.isRequestOutOfSync(o2, t)) {
          this.client.logger.info(`Discarding out of sync request - ${t}`);
          return;
        }
        this.isValidEmit(g3({ topic: e }, i3)), this.client.events.emit("session_event", { id: t, topic: e, params: i3 }), er.set(n3, t);
      } catch (n3) {
        await this.sendError(t, e, n3), this.client.logger.error(n3);
      }
      ...
      try {
        const { id: s, topic: t, params: i3 } = e, n3 = Mn(JSON.stringify(formatJsonRpcRequest("wc_sessionRequest", i3, s))), o2 = this.client.session.get(t), a3 = await this.getVerifyContext(n3, o2.peer.metadata);
        this.sessionRequestQueue.state = E3.active, this.client.events.emit("session_request", { id: s, topic: t, params: i3, verifyContext: a3 });
      } catch (s) {
        this.client.logger.error(s);
      }
      ...
      if (w(s) || await this.isValidPairingTopic(s), !Kt(o2, true)) {
      ...
      const o2 = this.client.proposal.get(s), a3 = cn(t, "approve()");
      if (a3)
        throw new Error(a3.message);
      const l2 = un(o2.requiredNamespaces, t, "approve()");
      if (l2)
      ...
      const o2 = Vt(t, "onSessionSettleRequest()");
      if (o2)
        throw new Error(o2.message);
      const a3 = cn(i3, "onSessionSettleRequest()");
      if (a3)
        throw new Error(a3.message);
      if (dt(n3)) {
      ...
      const i3 = this.client.session.get(s), n3 = cn(t, "update()");
      if (n3)
      ...
      if (!Wt(o2, i3, t.method)) {
        const { message: a3 } = N("MISSING_OR_INVALID", `request() method: ${t.method}`);
        throw new Error(a3);
      }
      if (n3 && !Qt(n3, U3)) {
        const { message: a3 } = N("MISSING_OR_INVALID", `request() expiry: ${n3}. Expiry must be a number (in seconds) between ${U3.min} and ${U3.max}`);
        throw new Error(a3);
      }
      ...
      try {
        ...
        i3 && (t.verified.origin = i3, t.verified.validation = i3 === new URL(s.url).origin ? "VALID" : "INVALID");
      } catch (i3) {
        this.client.logger.error(i3);
      }
  ...
  registerRelayerEvents() {
    this.client.core.relayer.on(D2.message, async (r2) => {
  ...
  registerExpirerEvents() {
    this.client.core.expirer.on(w2.expired, async (r2) => {
      const { topic: e, id: s } = ut(r2.target);
...
var Q3 = class extends b {
  constructor(r2) {
    ...
    const e = typeof (r2 == null ? void 0 : r2.logger) < "u" && typeof (r2 == null ? void 0 : r2.logger) != "string" ? r2.logger : (0, import_logger2.pino)((0, import_logger2.getDefaultLoggerOptions)({ level: (r2 == null ? void 0 : r2.logger) || M2.logger }));
    this.core = (r2 == null ? void 0 : r2.core) || new xr(r2), this.logger = (0, import_logger2.generateChildLogger)(e, this.name), this.session = new hs2(this.core, this.logger), this.proposal = new ps2(this.core, this.logger), this.pendingRequest = new ds2(this.core, this.logger), this.engine = new ls2(this);
  }
...
var x3 = Object.defineProperties;
...
var W3 = (e, t, s) => t in e ? P2(e, t, { enumerable: true, configurable: true, writable: true, value: s }) : e[t] = s;
var q3 = (e, t) => {
  for (var s in t || (t = {}))
    U4.call(t, s) && W3(e, s, t[s]);
  if (j2)
    for (var s of j2(t))
      T.call(t, s) && W3(e, s, t[s]);
  return e;
};
var A2 = (e, t) => x3(e, N11(t));
var S2 = (e, t, s) => {
  if (!t.has(e))
...
var z = class {
  constructor(t) {
    l(this, u2), l(this, n2), l(this, m2), l(this, h3, void 0), l(this, p4, void 0), l(this, w3, void 0), l(this, i2, void 0), y4(this, h3, t), y4(this, p4, o(this, u2, _2).call(this)), o(this, n2, r).call(this);
  }
  async connect(t) {
    const { requiredNamespaces: s, optionalNamespaces: d3 } = t;
    return new Promise(async (C3, b3) => {
      await o(this, n2, r).call(this);
      const E4 = a2(this, p4).subscribeModal((c2) => {
        c2.open || (E4(), b3(new Error("Modal closed")));
      }), { uri: O3, approval: I } = await a2(this, i2).connect(t);
      if (O3) {
        ...
        s && Object.values(s).forEach(({ chains: f2 }) => {
          ...
          f2 && f2.forEach((v) => c2.add(v));
        }), await a2(this, p4).openModal({ uri: O3, chains: Array.from(c2) });
      }
      try {
        const c2 = await I();
        C3(c2);
...
h3 = /* @__PURE__ */ new WeakMap(), p4 = /* @__PURE__ */ new WeakMap(), w3 = /* @__PURE__ */ new WeakMap(), i2 = /* @__PURE__ */ new WeakMap(), u2 = /* @__PURE__ */ new WeakSet(), _2 = function() {
  const { modalOptions: e, projectId: t } = a2(this, h3);
  return new d(A2(q3({}, e), { projectId: t }));
}, n2 = /* @__PURE__ */ new WeakSet(), r = async function() {
  return a2(this, i2) ? true : (!a2(this, w3) && typeof window < "u" && y4(this, w3, o(this, m2, g4).call(this)), a2(this, w3));
}, m2 = /* @__PURE__ */ new WeakSet(), g4 = async function() {
  y4(this, i2, await Q3.init({ metadata: a2(this, h3).metadata, projectId: a2(this, h3).projectId, relayUrl: a2(this, h3).relayUrl }));
